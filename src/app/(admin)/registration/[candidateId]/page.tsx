...
const CandidateDetailPage = ({
  ...
  const getCandidateData = async () => {
    const response = await GetCandidateById(params.candidateId);
  ...
  const getHistoryData = async () => {
    const response = await GetHistoryByTargetId(params.candidateId);
  ...
  const ApplicationSubmitService = async (data: any) => {
    ...
    const response = await UpdateApplication(params.candidateId, updatedData);
